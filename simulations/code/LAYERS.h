...
C -- Tracer flux fields
C  -- The following are temporary arrays that need to be stored.
C  -- They are in regular vertical coordinates.
C  -- The fourth index is tracer id: 1 for T and 2 for S
C      layers_trflux_dfx   :: zonal diffusive flux of T / S
C      layers_trflux_dfy   :: meridional diffusive flux of T / S
C      layers_trflux_afx   :: zonal advective flux of T / S
C      layers_trflux_afy   :: meridional advective flux of T / S

# ifdef LAYERS_TRACERFLUX
      COMMON /LAYERS_VAR_TRACERFLUX/
     &    layers_trflux_dfx, layers_trflux_dfy,
     &    layers_trflux_afx, layers_trflux_afy
      _RL layers_trflux_dfx(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,2,nSx,nSy)
      _RL layers_trflux_dfy(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,2,nSx,nSy)
      _RL layers_trflux_afx(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,2,nSx,nSy)
      _RL layers_trflux_afy(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,2,nSx,nSy)
